...
public class Teams {
	...
	public static String[] teamHongKongeleven() {
		String[] hkeleven = { "N.Khan", "Y.Murtaza", "B.Hayat", "K.Shah", "A.Khan", "Z.Ali", "S.McKechnie", "H.Arshad",
				"E.Khan", "A.Shukla", "M.Ghazanfar" };
	...
	public static void scoreBoard() {
		...
		System.out.println("\n" + teamtwoplayerdetails.get(1).getTeam() + "  " + bothteamScores[2] + " - "
				+ bothteamScores[3] + "                     " + teamoneplayerdetails.get(1).getTeam() + "  "
				+ bothteamScores[0] + " - " + bothteamScores[1]);
